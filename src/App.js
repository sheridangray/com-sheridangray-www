  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        />
        <Route exact path='/health' activeClassName="active" element={<HealthPage />} />
        <Route exact path='/relationships' activeClassName="active" element={<RelationshipsPage />} />
        <Route exact path='/money' activeClassName="active" element={<MoneyPage />} />
        <Route exact path='/happiness' activeClassName="active" element={<HappinessPage />} />
        <Route exact path='/food' activeClassName="active" element={<FoodPage />} />
        <Route exact path='/playground' activeClassName="active" element={<PlaygroundPage />} />
      </Routes>
    </div>
  );
}
